...
def main():
    ...
    process_list = [
        ...
        Process(target = recup_all_data, args=(date(2024, 4, 24), date(2024, 5, 25))),
        # Process(target = recup_all_data, args=(date(2023, 5, 1), date(2023, 6, 1))),
        # Process(target = recup_all_data, args=(date(2023, 4, 25), date(2023, 5, 1))),#in e_paris cotes after 01072023 havent been goten
        ...
        # Process(target = recup_all_data, args=(date(2023, 11, 29), date(2023, 12, 1))),
        # Process(target = recup_all_data, args=(date(2023, 12, 31), date(2023, 12, 31))),
