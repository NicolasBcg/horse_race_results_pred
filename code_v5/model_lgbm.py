...
def train_lgbm(directory_encode,params,num_boost_round,sufix,display_probs = False):
    ...
    joblib.dump(model, PATH + directory_encode +"/"+directory_encode +"-lgbm-" + sufix + ".dat")
